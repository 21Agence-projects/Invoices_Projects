<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">{{ env('APP_NAME') }}</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">إرشيف الفواتير</a></li>
						</ul>
					</li>
					{{-- <li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='mail-compose') }}">صلاحيات قائمة </a></li>
						</ul>
					</li>
